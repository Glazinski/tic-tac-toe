...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/DOMHelpers.ts":[function(require,module,exports) {
"use strict";
...
var DOMHelpers = function DOMHelpers() {
  var _this = this;
  ...
  this.getElement = function (selector) {
    ...
    var errMsg = 'Element was not found in the dom';
  ...
  this.getAllElements = function (selector) {
    ...
    var errMsg = 'Elements were not found in the dom';
    throw new Error(errMsg);
  };
  ...
  this.removeNodesContent = function (selector, classToRemove) {
    var elements = _this.getAllElements(selector);
  ...
  this.removeElement = function (selector) {
    var elementToRemove = _this.getElement(selector);
...
var Menu = /*#__PURE__*/function (_DOMHelpers_1$DOMHelp) {
  _inherits(Menu, _DOMHelpers_1$DOMHelp);
  ...
  function Menu(parentElement) {
    ...
    _this.show = function (callback) {
      ...
      _this.circleBtn = _this.getElement('.circle-btn');
      _this.crossBtn = _this.getElement('.cross-btn');

      _this.circleBtn.addEventListener('click', function () {
        return callback('o');
      });

      _this.crossBtn.addEventListener('click', function () {
        return callback('x');
      });
    };

    _this.rootElement = _this.createElement('div', 'menu');
    return _this;
  }

  return Menu;
}(DOMHelpers_1.DOMHelpers);

exports.Menu = Menu;
},{"./DOMHelpers":"src/DOMHelpers.ts"}],"src/types/Players.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
},{}],"src/types/Board.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
},{}],"src/types/PlayersScore.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
},{}],"src/types/Directions.ts":[function(require,module,exports) {
"use strict";
...
(function (Directions) {
  ...
  Directions[Directions["LeftDiagonal"] = 2] = "LeftDiagonal";
  Directions[Directions["RightDiagonal"] = 3] = "RightDiagonal";
})(Directions = exports.Directions || (exports.Directions = {}));
},{}],"src/types/index.ts":[function(require,module,exports) {
"use strict";
...
__exportStar(require("./PlayersScore"), exports);

__exportStar(require("./Directions"), exports);
},{"./Players":"src/types/Players.ts","./Board":"src/types/Board.ts","./PlayersScore":"src/types/PlayersScore.ts","./Directions":"src/types/Directions.ts"}],"node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/Game.ts":[function(require,module,exports) {
"use strict";
...
var Game = /*#__PURE__*/function (_DOMHelpers_1$DOMHelp) {
  _inherits(Game, _DOMHelpers_1$DOMHelp);

  var _super = _createSuper(Game);

  function Game(menu, board, score, animations) {
    var _this;
    ...
    _this.isGameWon = function (row, col) {
      // Horizontal win
      var isWin = false;
      var boardSelector = '.board';

      if (_this.gameBoard[row][0] === _this.currentPlayer && _this.gameBoard[row][1] === _this.currentPlayer && _this.gameBoard[row][2] === _this.currentPlayer) {
        _this.animations.animateLine(boardSelector, ".row--".concat(row + 1), types_1.Directions.Horizontal);

        isWin = true;
      } // Vertical win
      else if (_this.gameBoard[0][col] === _this.currentPlayer && _this.gameBoard[1][col] === _this.currentPlayer && _this.gameBoard[2][col] === _this.currentPlayer) {
          _this.animations.animateLine(boardSelector, ".game-btn--".concat(col + 1), types_1.Directions.Vertical);

          isWin = true; // return true;
        } // Diagonal win left bottom corner to right upper corner
        else if (_this.gameBoard[0][0] === _this.currentPlayer && _this.gameBoard[1][1] === _this.currentPlayer && _this.gameBoard[2][2] === _this.currentPlayer) {
            _this.animations.animateLine(boardSelector, boardSelector, types_1.Directions.LeftDiagonal);

            isWin = true; // return true;
          } // Diagonal win left upper corner to right bottom corner
          else if (_this.gameBoard[2][0] === _this.currentPlayer && _this.gameBoard[1][1] === _this.currentPlayer && _this.gameBoard[0][2] === _this.currentPlayer) {
              _this.animations.animateLine(boardSelector, boardSelector, types_1.Directions.RightDiagonal);

              isWin = true; // return true;
            } else if (_this.isDraw()) {
              // this.printMessage('Draw');
              _this.animations.printAnimatedMessage('Draw');

              setTimeout(function () {
                _this.startNextRound();
              }, 1000);
            }

      if (isWin) {
        _this.board.rootElement.style.pointerEvents = 'none';
        return true;
      }
    ...
    _this.switchPlayer = function () {
      _this.currentPlayer = _this.currentPlayer === 'x' ? 'o' : 'x';
    };

    _this.increaseScore = function () {
      _this.playersScore[_this.currentPlayer] += 1;

      _this.score.updateTableScore(_this.currentPlayer, _this.playersScore[_this.currentPlayer]);
    };

    _this.startNextRound = function () {
      _this.board.clearBoard();

      _this.board.rootElement.style.pointerEvents = 'auto';
    };

    _this.onCellButtonClick = function (event) {
      // In this case el stands for cell in board
      var element = event.currentTarget;
      var col = element.dataset.col;
      var row = element.parentNode.dataset.row;
      var c = +col;
      var r = +row;
      element.innerHTML = _this.players[_this.currentPlayer];
      element.classList.add('unclickable');
      gsap_1.default.fromTo(element.childNodes[0], 0.2, {
        scale: 0.2
      }, {
        scale: 1
      });
      _this.gameBoard[r][c] = _this.currentPlayer;

      if (_this.isGameWon(r, c)) {
        _this.increaseScore();
    ...
    _this.onResetButtonClick = function () {
      _this.score.clearTableScore();

      _this.board.clearBoard();

      _this.resetScores();

      _this.removeElement('.board');

      _this.removeElement('.score');

      _this.showStartMenu();
    };

    _this.onStartButtonClick = function (currentPlayer) {
      _this.menu.hide();

      _this.startGame(currentPlayer);
    };

    _this.showStartMenu = function () {
      _this.menu.show(_this.onStartButtonClick);
    };

    _this.isDraw = function () {
      var length = _this.gameBoard.length;

      for (var i = 0; i < length; i++) {
        for (var j = 0; j < length; j++) {
          if (_this.gameBoard[i][j].length === 0) {
            return false;
          }
        }
      }
    ...
    _this.startGame = function (currPlayer) {
      _this.currentPlayer = currPlayer; // I pass reference to onButtonClick function
      // so it can be attach as event listener to each cell

      _this.board.generateBoard(_this.onCellButtonClick); // P1 stands for player 1 and it is always going to be
      // choosed team by player, so it can be cross or circle


      var p1 = _this.currentPlayer;
      var p2 = _this.currentPlayer === 'x' ? 'o' : 'x';

      _this.score.generateTableScore(p1, p2, _this.onResetButtonClick);
    };
...
exports.Game = Game;
},{"./types":"src/types/index.ts","./DOMHelpers":"src/DOMHelpers.ts","gsap":"node_modules/gsap/index.js"}],"src/CasualBoard.ts":[function(require,module,exports) {
"use strict";
...
var CasualBoard = /*#__PURE__*/function (_DOMHelpers_1$DOMHelp) {
  _inherits(CasualBoard, _DOMHelpers_1$DOMHelp);

  var _super = _createSuper(CasualBoard);

  function CasualBoard(parentElement) {
    var _this;

    _classCallCheck(this, CasualBoard);

    _this = _super.call(this);
    _this.parentElement = parentElement;

    _this.generateEmptyBoard = function () {
      return [['', '', ''], ['', '', ''], ['', '', '']];
    };

    _this.generateBoard = function (callback) {
      _this.parentElement.appendChild(_this.rootElement);

      var html = '';

      for (var i = 0; i < 3; i++) {
        html += "\n        <div class=\"row row--".concat(i + 1, "\" data-row=\"").concat(i, "\">\n          <button class=\"game-btn game-btn--1\" data-col=\"0\"></button>\n          <button class=\"game-btn game-btn--2\" data-col=\"1\"></button>\n          <button class=\"game-btn game-btn--3\" data-col=\"2\"></button>\n        </div>\n      ");
      }

      _this.rootElement.innerHTML = html;
      gsap_1.default.fromTo(_this.rootElement, 0.3, {
        scale: 0.2
      }, {
        scale: 1
      });
    ...
    _this.clearBoard = function () {
      _this.gameBoard = _this.generateEmptyBoard();

      _this.removeNodesContent('.game-btn', 'unclickable');
    };

    _this.rootElement = _this.createElement('div', 'board');
    _this.gameBoard = _this.generateEmptyBoard();
    return _this;
  }
...
},{"./DOMHelpers":"src/DOMHelpers.ts","gsap":"node_modules/gsap/index.js"}],"src/Score.ts":[function(require,module,exports) {
"use strict";
...
var Score = /*#__PURE__*/function (_DOMHelpers_1$DOMHelp) {
  _inherits(Score, _DOMHelpers_1$DOMHelp);
  ...
  function Score(parentElement) {
    ...
    _this.generateTableScore = function (p1, p2, callback) {
      var html = "\n      <div class=\"score__players\">\n        <div class=\"score__player\">\n          <span class=\"player-icon\">\n            ".concat(_this.players[p1], "\n          </span>:\n          <div class=\"player\" id=\"player-").concat(p1, "\">\n            0\n          </div> \n        </div>\n        <div class=\"score__player\">\n          <span class=\"player-icon\">\n            ").concat(_this.players[p2], "\n          </span>:\n          <div class=\"player\" id=\"player-").concat(p2, "\">\n            0\n          </div>\n        </div>\n      </div>\n      <button class=\"score__restart-btn\">RESTART GAME</button>\n    ");
      _this.rootElement.innerHTML = html;

      _this.parentElement.appendChild(_this.rootElement);

      var resetButton = _this.getElement('.score__restart-btn');

      resetButton.addEventListener('click', callback);
    };

    _this.updateTableScore = function (player, score) {
      var elRef = document.getElementById("player-".concat(player));
      elRef.innerHTML = score.toString();
    };

    _this.clearTableScore = function () {
      _this.removeNodesContent('.player');
    };

    _this.rootElement = _this.createElement('div', 'score');
    _this.players = {
      x: '<i class="icon fas fa-times"></i>',
      o: '<i class="icon far fa-circle"></i>'
    };
...
exports.Score = Score;
},{"./DOMHelpers":"src/DOMHelpers.ts"}],"src/Animations.ts":[function(require,module,exports) {
"use strict";
...
var Animations = /*#__PURE__*/function (_DOMHelpers_1$DOMHelp) {
  _inherits(Animations, _DOMHelpers_1$DOMHelp);

  var _super = _createSuper(Animations);
  ...
  function Animations() {
    ...
    _this.printAnimatedMessage = function (msg) {
      var msgElement = _this.createElement('div', 'message');

      msgElement.innerHTML = msg;
      document.body.insertAdjacentElement('afterbegin', msgElement);
      gsap_1.default.from(msgElement, 1, {
        translateY: 20
      });
      setTimeout(function () {
        msgElement.remove();
    ...
    _this.animateLine = function (selector, basedSelector, direction) {
      _this.boardElement = _this.getElement(selector);

      var _this$boardElement$ge = _this.boardElement.getBoundingClientRect(),
          height = _this$boardElement$ge.height,
          width = _this$boardElement$ge.width;

      document.body.insertAdjacentElement('afterbegin', _this.stripe);

      var basedElement = _this.getElement(basedSelector);

      var _basedElement$getBoun = basedElement.getBoundingClientRect(),
          basedX = _basedElement$getBoun.x,
          basedY = _basedElement$getBoun.y,
          basedHeight = _basedElement$getBoun.height,
          basedWidth = _basedElement$getBoun.width;

      var diagonalWidth = Math.sqrt(Math.pow(width, 2) + Math.pow(height, 2));

      if (direction === Directions_1.Directions.Horizontal) {
        gsap_1.default.set(_this.stripe, {
          x: basedX,
      ...
      } else if (direction === Directions_1.Directions.Vertical) {
        gsap_1.default.set(_this.stripe, {
      ...
      } else if (direction === Directions_1.Directions.LeftDiagonal) {
        gsap_1.default.set(_this.stripe, {
          x: basedX,
          y: basedY - 6,
          width: diagonalWidth,
      ...
      } else if (direction === Directions_1.Directions.RightDiagonal) {
        gsap_1.default.set(_this.stripe, {
      ...
      gsap_1.default.fromTo(_this.stripe, 0.6, {
        scaleX: 0
      }, {
        scaleX: 1
      });
    ...
    _this.stripe = _this.createElement('div', 'line');
    _this.boardElement = _this.createElement('div');
    return _this;
  }
...
},{"gsap":"node_modules/gsap/index.js","./DOMHelpers":"src/DOMHelpers.ts","./types/Directions":"src/types/Directions.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var game = new Game_1.Game(new Menu_1.Menu(app), new CasualBoard_1.CasualBoard(app), new Score_1.Score(app), new Animations_1.Animations());
game.showStartMenu();
},{"./Menu":"src/Menu.ts","./Game":"src/Game.ts","./CasualBoard":"src/CasualBoard.ts","./Score":"src/Score.ts","./Animations":"src/Animations.ts"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
